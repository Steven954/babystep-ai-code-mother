...
/**
 * 绠€鍖栫増甯︾姸鎬佸畾涔夌殑宸ヤ綔娴?- 鍙畾涔夌姸鎬佺粨鏋勶紝涓嶅疄鐜板叿浣撴祦杞?
 */
@Slf4j
public class SimpleStatefulWorkflowApp {
    ...
    static AsyncNodeAction<MessagesState<String>> makeStatefulNode(String nodeName, String message) {
        return node_async(state -> {
            ...
            log.info("鎵ц鑺傜偣: {} - {}", nodeName, message);
            // 鍙褰曞綋鍓嶆楠わ紝涓嶅仛鍏蜂綋鐨勭姸鎬佹祦杞?
            if (context != null) {
    ...
    public static void main(String[] args) throws GraphStateException {
        ...
        CompiledGraph<MessagesState<String>> workflow = new MessagesStateGraph<String>()
                // 娣诲姞鑺傜偣 - 浣跨敤甯︾姸鎬佹劅鐭ョ殑鑺傜偣
                .addNode("image_collector", makeStatefulNode("image_collector", "鑾峰彇鍥剧墖绱犳潗"))
                .addNode("prompt_enhancer", makeStatefulNode("prompt_enhancer", "澧炲己鎻愮ず璇?"))
                .addNode("router", makeStatefulNode("router", "鏅鸿兘璺敱閫夋嫨"))
                .addNode("code_generator", makeStatefulNode("code_generator", "缃戠珯浠ｇ爜鐢熸垚"))
                .addNode("project_builder", makeStatefulNode("project_builder", "椤圭洰鏋勫缓"))
